...
class Approve_kembali_model extends MY_Model
{
    ...
    protected $column_search = array('tanggal_pinjam','jadwal_kembali','no_anggota','nama','nama_kelas','label_buku'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    {
        $this->db->from($this->table)->where('status','3');
        return $this->db->count_all_results();
    }
    ////////////////////////////////////

    //kembalikan buku dan denda
