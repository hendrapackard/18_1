...
class Pengembalian_anggota_model extends MY_Model
{
    ...
    public function count_all_kembali($id_user)
    {
        $this->db->from($this->table)->where('id_user',$id_user)->where('status','2');
