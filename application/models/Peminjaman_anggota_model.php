...
class Peminjaman_anggota_model extends MY_Model
{
    ...
    protected $order = array('tanggal_pinjam' => 'desc','id_pinjam' => 'desc'); // default order

    protected function _get_datatables_query($id_user)
    {
    ...
    public function insert2($input)
    {
        ...
        $data  = $this->prepData($kode_pinjam,$tanggal_pinjam,$jadwal_kembali,$id_user,$id_bukus);
    ...
    private function prepData($kode_pinjam,$tanggal_pinjam,$jadwal_kembali,$id_user,$id_bukus)
    {
        $i = 0;
        $data = [];
