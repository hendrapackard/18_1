...
<table width="600" border="1">
    ...
    <?php foreach ($pengembalians as $kembali): ?>
        ...
        <td width="70"><?= date('d-m-Y', strtotime($kembali->tanggal_kembali)) ?></td>
        <td width="50"><?= $kembali->no_induk ?></td>
        <td width="120"><?= ucfirst($kembali->nama) ?></td>
        <td width="70"><?= $kembali->label_buku ?></td>
    ...
    <tfoot>
    <tr>
        <td colspan="6"><strong>Jumlah Pengembalian : <?= $jumlah_total ?></strong></td>
    </tr>
    </tfoot>
</table>
